class LedgersController < ApplicationController
  ...
  def index
    ...
    render json: @ledgers.to_json(include: [:playlist, :lesson])
  end

  # GET /ledgers/1
  def show
    render json: @ledger.to_json(include: [:playlist, :lesson])
  end
  ...
  private
    ...
    def ledger_params
      params.require(:ledger).permit(:playlist_id, :lesson_id)
    end
end
